...
// import { Link2, Sparkles, FileText, UploadCloud, AlertCircle, CheckCircle2 } from 'lucide-react';
...
//     try {
//       const response = await urlAPI.create(originalUrl.trim());
...
//   return (
//     <div className="cyber-panel p-5 sm:p-7 rounded-2xl border border-white/5 bg-slate-900/40 backdrop-blur-xl h-fit w-full shadow-2xl">
      
//       {/* Toggle View Tabs Component Matrix */}
...
//           className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-semibold transition-all outline-none ${
//             activeTab === 'single'
//               ? 'bg-slate-800 text-white border border-white/5 shadow-md'
...
//               required
//               className="w-full bg-slate-950 border border-white/20 focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 text-slate-200 placeholder-slate-600 px-4 py-3 rounded-xl text-sm transition-all outline-none"
//             />
//           </div>
...
//             className="w-full bg-gradient-to-r from-indigo-600 to-cyan-600 hover:from-indigo-500 hover:to-cyan-500 disabled:from-slate-800 disabled:to-slate-800 disabled:text-slate-500 disabled:cursor-not-allowed text-white font-medium text-sm py-3 rounded-xl transition-all shadow-lg shadow-indigo-600/10 flex items-center justify-center gap-2 outline-none active:scale-[0.99]"
//           >
//             {loading ? (
//               <>
//                 <div className="w-4 h-4 border-2 border-slate-400 border-t-white rounded-full animate-spin" />
//                 <span>Shortening Code...</span>
//               </>
//             ) : (
//               <>
...
//             }}
//             className="w-full bg-slate-950 border border-white/20 focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 text-slate-200 placeholder-slate-600 px-4 py-3 rounded-xl text-sm font-mono transition-all outline-none resize-none custom-scrollbar"
//           />
//         </div>
...
//           className="w-full bg-gradient-to-r from-cyan-600 to-indigo-600 hover:from-cyan-500 hover:to-indigo-500 disabled:from-slate-800 disabled:to-slate-800 disabled:text-slate-500 disabled:cursor-not-allowed text-white font-medium text-sm py-3 rounded-xl transition-all shadow-lg shadow-cyan-600/10 flex items-center justify-center gap-2 outline-none active:scale-[0.99]"
//         >
//           {loading ? (
//             <>
//               <div className="w-4 h-4 border-2 border-slate-400 border-t-white rounded-full animate-spin" />
