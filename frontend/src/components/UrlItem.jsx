...
//               type="button"
//               onClick={handleCopy}
//               className={`p-1.5 rounded-lg hover:bg-white/5 transition-all outline-none ${
...
//         {/* Truncated Destination Pointer */}
//         <td className="px-6 py-4 max-w-xs xl:max-w-sm">
//           <a
...
//         {/* System Interactive Control Deck */}
//         <td className="px-6 py-4">
//           <div className="flex items-center gap-2">
//             <Link
//               to={`/analytics/${url.shortCode}`}
//               className="inline-flex items-center gap-1 text-xs font-semibold text-indigo-400 bg-indigo-500/10 hover:bg-indigo-500/20 border border-indigo-500/20 hover:border-indigo-500/30 px-2.5 py-1.5 rounded-lg transition-all outline-none"
//               title="View detailed analytical matrices"
//             >
...
//               type="button"
//               onClick={() => onEdit(url)}
//               className="inline-flex items-center gap-1 text-xs font-semibold text-slate-300 bg-white/5 hover:bg-white/10 border border-white/5 hover:border-white/10 px-2.5 py-1.5 rounded-lg transition-all outline-none"
//               title="Edit original destination link"
//             >
...
//               className="inline-flex items-center justify-center text-rose-400 bg-rose-500/5 hover:bg-rose-500/10 border border-rose-500/10 hover:border-rose-500/20 p-1.5 rounded-lg transition-all outline-none"
//               title="Purge link route node from server"
//             >
...
//               type="button"
//               onClick={handleCopy}
//               className={`p-1.5 rounded-lg bg-white/5 ${copied ? 'text-emerald-400' : 'text-slate-400'}`}
//             >
//               {copied ? <Check className="w-3.5 h-3.5" /> : <Copy className="w-3.5 h-3.5" />}
//             </button>
//           </div>
...
//             <Link
//               to={`/analytics/${url.shortCode}`}
//               className="inline-flex items-center gap-1 text-xs font-semibold text-indigo-400 bg-indigo-500/10 border border-indigo-500/20 px-2.5 py-1.5 rounded-lg"
//             >
//               <BarChart2 className="w-3.5 h-3.5" />
//               <span>Stats</span>
//             </Link>
...
//               type="button"
//               onClick={() => onEdit(url)}
//               className="inline-flex items-center gap-1 text-xs font-semibold text-slate-300 bg-white/5 border border-white/5 px-2.5 py-1.5 rounded-lg"
//             >
//               <Edit2 className="w-3.5 h-3.5 text-slate-400" />
//               <span>Edit</span>
//             </button>
...
//               type="button"
//               onClick={() => onDelete(url._id)}
//               className="inline-flex items-center justify-center text-rose-400 bg-rose-500/10 border border-rose-500/20 p-2 rounded-lg"
//             >
//               <Trash2 className="w-3.5 h-3.5" />
//             </button>
//           </div>
